...
public interface OnPaymentListener {
	...
	public void onVoidPaymentStarted(int financialTransactionType, int amount, String currency, boolean cardHolderPresent, String originalTransactionId, long originalId);
